...
const ShowListing = () => {
  ...
  return (
    <div>
      ...
      {console.log(listing)}
      <h1 className="text-5xl font-medium leading-10 text-center md:text-6xl">
      ...
      <div className="flex justify-center w-auto mx-auto lex-row my-14">
        ...
        <div className="flex flex-col w-1/2 md:w-1/3">
          ...
          <div className="flex">
            ...
            <div className="p-2 my-4 text-xs border-2 rounded-r-lg text-lightGray lg:w-32 sm:w-18 md:w-24">
              <p>UNTIL</p>
